...
test_search_flags = [
    ...
    (['--producttype', 'SLC',
     ...
     "Product 2223103a-3754-473d-9a29-24ef8efa2880 - Date: 2016-12-01T09:30:22.149Z, "
     "Instrument: SAR-C SAR, Mode: VV VH, Satellite: Sentinel-1, Size: 7.98 GB"),
    ...
    (['--sentinel', '1',
     ...
     "Product 6a62313b-3d6f-489e-bfab-71ce8d7f57db - Date: 2015-12-24T09:40:34.129Z, "
     "Instrument: SAR-C SAR, Mode: VV VH, Satellite: Sentinel-1, Size: 7.7 GB"),
    ...
    (['--sentinel', '2',
     ...
     "Product 91c2503c-3c58-4a8c-a70b-207b128e6833 - Date: 2015-12-27T14:22:29Z, "
     "Instrument: MSI, Mode: , Satellite: Sentinel-2, Size: 5.73 GB"),
    ...
    (['--sentinel', '3',
     ...
     "Product 50d27cb5-70da-41c9-b0f3-023cfb25d781 - Date: 2016-12-01T13:13:17.65Z, "
     "Instrument: SRAL, Mode: , Satellite: Sentinel-3, Size: 76.62 MB"),

    (['--uuid', 'd8340134-878f-4891-ba4f-4df54f1e3ab4',
      '-s', '20161201',
      '-e', '20161202'],

     "Product d8340134-878f-4891-ba4f-4df54f1e3ab4 - "
     "S1A_WV_OCN__2SSV_20150526T211029_20150526T211737_006097_007E78_134A - 0.12 MB"),

    (['--name', 'S1A_WV_OCN__2SSV_20150526T211029_20150526T211737_006097_007E78_134A',
      '-s', '20161201',
      '-e', '20161202'],

     "Product d8340134-878f-4891-ba4f-4df54f1e3ab4 - Date: 2015-05-26T21:10:28.984Z, "
     "Instrument: SAR-C SAR, Mode: VV, Satellite: Sentinel-1, Size: 10.65 KB"),
]


@pytest.mark.parametrize("args, expected_product_info", test_search_flags)
@my_vcr.use_cassette
@pytest.mark.scihub
def test_search_flags(args, expected_product_info):
    runner = CliRunner()
    ...
    product_infos = re.findall("^Product .+$", result.output, re.M)
    assert len(product_infos) > 0
    if expected_product_info is not None:
        assert expected_product_info in product_infos
